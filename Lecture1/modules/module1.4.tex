...
\begin{figure}
\centering
\only<1>{\includegraphics[scale=0.3]{"images/module4/1959"}}
\only<2>{\includegraphics[scale=0.5]{"images/module4/1980"}}
\only<3>{\includegraphics[scale=0.5]{"images/module4/1989"}}
\only<4>{\includegraphics[scale=0.5]{"images/module4/1998"}}
\end{figure}
\end{overlayarea}
\end{columns}
\end{minipage}
