...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\begin{overlayarea}{\textwidth}{\textheight}
				\vspace{0.2in}
				\includegraphics[width=0.8\linewidth]{images/module8/speechrecog}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\begin{overlayarea}{\textwidth}{\textheight}
				\vspace{0.2in}
				\includegraphics[width=1\linewidth]{images/module8/Mt}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=0.85\linewidth]{images/module8/cm}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		...
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/qa2}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/or}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=\linewidth]{images/module8/vt}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/ic}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/vc}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/visualQA.png}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\textwidth]{images/module8/video-abstraction.png}\\
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[scale=0.5]{images/module8/va}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/wave}
			\end{overlayarea}
		\end{column}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.6\textwidth}
			\vspace{0.2in}
			\begin{overlayarea}{\textwidth}{\textheight}
				\includegraphics[width=1\linewidth]{images/module8/pixel_rnn}
			\end{overlayarea}
		\end{column}
		\begin{column}{0.4\textwidth}
			\begin{overlayarea}{\textwidth}{\textheight}
