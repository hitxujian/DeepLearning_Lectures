...
\only<1>{\node at (-5.5,-0.5) (figa)  { \includegraphics[scale=0.22]{images/reimage/1.jpg}};}
\only<2>{\node at (-5.5,-0.5) (figa)  { \includegraphics[scale=0.22]{images/reimage/2.jpg}};}
\only<3>{\node at (-5.5,-0.5) (figa)  { \includegraphics[scale=0.22]{images/reimage/3.jpg}};}
\only<4>{\node at (-5.5,-0.5) (figa)  { \includegraphics[scale=0.22]{images/reimage/4.jpg}};}
\only<5>{\node at (-5.5,-0.5) (figa)  { \includegraphics[scale=0.22]{images/reimage/5.jpg}};}
\only<6>{\node at (-5.5,-0.5) (figa)  { \includegraphics[scale=0.22]{images/reimage/6.jpg}};}
\draw[->](-2.9,-0.4)--(0,-0.4) ;
...
\only<1>{\cuboid{(20.5+1,1,0)}{green}{0.5}{0.5}{0}{256}{2}{2}
\node (a) at (20.2+2,0.8,0) {\small Dumbell};}

\only<2>{\cuboid{(20.5+1,0.7,0)}{green}{0.5}{0.5}{0}{256}{2}{2}
\node (a) at (20.2+1.8,0.5,0) {\small Cup};}

\only<3>{\cuboid{(20.5+1,-1.3,0)}{green}{0.5}{0.5}{0}{256}{2}{2}
\node (a) at (20.2+2.2,-1.5,0) {\small Dalmation};}

\only<4>{\cuboid{(20.5+1,-2,0)}{green}{0.5}{0.5}{0}{256}{2}{2}
\node (a) at (20.2+2.2,-2.2,0) {\small Bell Pepper};}

\only<5>{\cuboid{(20.5+1,0,0)}{green}{0.5}{0.5}{0}{256}{2}{2}
\node (a) at (20.2+2,-0.2,0) {\small Lemon};}

\only<6>{\cuboid{(20.5+1,1.4,0)}{green}{0.5}{0.5}{0}{256}{2}{2}
\node (a) at (20.2+2,1.2,0) {\small Husky};}
