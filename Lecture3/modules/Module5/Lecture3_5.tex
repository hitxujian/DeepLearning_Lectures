\begin{frame}
	\myheading{Module 3.5: Representation Power of Multilayer Network of Sigmoid Neurons}
\end{frame}
	...
	\begin{columns}
		...
		\begin{overlayarea}{\textwidth}{\textheight}
			\begin{itemize}\justifying
				...
				\item We need to figure out how to get a 3-dimensional tower
...
\begin{frame}
	\begin{columns}
		...
		\begin{overlayarea}{\textwidth}{\textheight}
			\begin{figure}
				\includegraphics<1-2>[scale=0.20]{images/module5/Plots/scatter}
		...
		\begin{overlayarea}{\textwidth}{\textheight}
			\begin{figure}
				\includegraphics<5->[scale=0.13]{images/module5/Plots/g2.png}
			\end{figure}
			\vspace{-0.2in}
			\footnotesize{
			\begin{itemize}\justifying
